...
if __name__ == '__main__':
    # Leaf
    camiseta1 = Product('Camiseta1', 50)
    camiseta2 = Product('Camiseta2', 45)
    camiseta3 = Product('Camiseta3', 35)
    ...
    smartphone2 = Product('smartphone2', 3000)
    ...
    # Outro composite (Box dentro de box)
    caixa_encomenda = Box('Caixa para entrega')
    caixa_encomenda.add(caixa_smartphones)
    caixa_encomenda.add(caixa_camisetas)
    caixa_encomenda.print_content()
    print(caixa_encomenda.get_price())
